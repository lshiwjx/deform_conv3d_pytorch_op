...
void shape_check(THCState *state,
                 THCudaDoubleTensor *input, THCudaDoubleTensor *weight, THCudaDoubleTensor *output,
                 THCudaDoubleTensor *columns,
                 const int pad_h, const int pad_w,
                 const int stride_h, const int stride_w,
                 const int dilation_h, const int dilation_w,
                 const int group) {
    THCAssertSameGPU(THCudaDoubleTensor_checkGPU(state, 4, input, weight, output, columns));
